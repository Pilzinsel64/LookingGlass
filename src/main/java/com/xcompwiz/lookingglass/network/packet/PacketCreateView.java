...
public class PacketCreateView extends PacketHandlerBase {
    ...
    public void handle(ByteBuf data, EntityPlayer player) {
        ...
        ChunkFinderManager.instance.addFinder(
            new ChunkFinder(new ChunkCoordinates(x, y, z), dim, world.getChunkProvider(), player, renderDistance));
        // TODO: Add to tracking list. Send time/data updates at intervals. Keep in mind to catch player disconnects
