...
public interface IViewCamera {
    ...
    /**
     * This is provided to allow for checking for air blocks and similar. Technically, it is a WorldClient object, but
     * it is provided as a IBlockAccess to
     * discourage modifying the world. Modifying the world object would break things for everyone, so please don't do
     * that. Should it become an issue, this will
    ...
    /**
     * Since LookingGlass utilizes partial chunk loading to minimize data traffic and storage, it's useful to be able to
     * check if certain levels of a chunk are
     * loaded locally.
     * 
     * @param x   The X coordinate in block space
     * @param z   The Z coordinate in block space
