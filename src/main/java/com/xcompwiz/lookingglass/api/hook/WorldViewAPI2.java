...
public interface WorldViewAPI2 {
    ...
    /**
     * Creates a world viewer object which will handle the rendering and retrieval of the remote location. Can return
     * null.
     * 
    ...
    /**
     * This function is available should you wish to explicitly have the world view clean up its framebuffer. You should
     * not use a view after calling this on
     * the view.
     * 
