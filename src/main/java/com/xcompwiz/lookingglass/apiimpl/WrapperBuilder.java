...
/**
 * This is a bit of a magic class. We use it to build API instances (API wrappers). It requires that the target class
 * have a constructor which takes a string.
 * It passes the API instance "owner" to the constructor when building the wrapper instance. Basically a cheap and easy
 * class factory.
 */
public class WrapperBuilder {
     ...
     * @return The instance
     */
    public Object newInstance(String owner)
