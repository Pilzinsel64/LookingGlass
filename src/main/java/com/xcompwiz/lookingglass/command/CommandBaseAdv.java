...
public abstract class CommandBaseAdv extends CommandBase {
    ...
    public static EntityPlayerMP getTargetPlayer(ICommandSender sender, String target) {
        ...
        if (entityplayermp == null) {
            entityplayermp = MinecraftServer.getServer()
    ...
    public static double handleRelativeNumber(ICommandSender par1ICommandSender, double origin, String arg, int min,
        int max) {
        ...
        if (min != 0 || max != 0) {
            if (d1 < min) {
                throw new NumberInvalidException(
                    ...
                    new Object[] { Double.valueOf(d1), Integer.valueOf(min) });
            }
