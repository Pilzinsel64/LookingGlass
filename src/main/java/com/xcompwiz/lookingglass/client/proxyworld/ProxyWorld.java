...
public class ProxyWorld extends WorldClient {
    ...
    // TODO: In order to eliminate this class we may need an event in this function to allow canceling/redirecting
    // sounds
    @Override
    public void playSound(double par1, double par3, double par5, String par7Str, float par8, float par9,
        boolean par10) {}

    // TODO: In order to eliminate this class we need to create a redirection wrapper class for the mc.effectRenderer
    // which does this for all views.
    @Override
